        ...
        <div className="bg-white flex max-375:flex-col max-375:items-center justify-between w-[70vw] max-375:w-screen h-[55vh] max-375:h-4/5 rounded-2xl  max-375px:rounded-b-none overflow-hidden p-5">
          <div className="w-[45%] max-375:w-full flex flex-col justify-between max-375:h-1/2">
            <div className="max-375:w-full">
              <h2 className="text-grayishCyan text-[30px]">Bill</h2>
              <div className="flex bg-verylightGrayishCyan p-[0rem_.5rem] hover:border-strongCyan border-2 border-transparent rounded-md items-center">
                ...
                <input
                  className="w-11/12 h-full bg-transparent text-veryDarkCyan text-[45px] text-right"
                  type="number"
                  name="Bill"
                  value={total}
            ...
            <div className="max-375:w-full">
              <h2 className="text-grayishCyan text-[30px]">Select Tip</h2>
              <div className="grid grid-cols-3 max-375:grid-cols-2 gap-2">
                ...
                <input
                  className="w-full text-[35px] h-full bg-verylightGrayishCyan text-veryDarkCyan text-center"
                  type="number"
                  name="custom"
            ...
            <div className="max-375:w-full">
              ...
              <h2 className={`text-grayishCyan text-[30px] `}>Number of People</h2>
              <h2 className={`${partySize==0? null:"hidden"} text-[30px] text-red-500`}>Can't be Zero</h2>
              </div>
              <div className={`flex bg-verylightGrayishCyan ${(partySize==0) ? "border-red-500": "hover:border-strongCyan border-transparent"} p-[0rem_.5rem] rounded-md border-2 items-center`}>
                <img className="w-1/12 " src={personIcon} />
                <input
                  className={`w-11/12 h-full bg-transparent  text-veryDarkCyan text-right text-[45px]`}
                  type="number"
                  name="People"
                  value={partySize}
          ...
          <div className="bg-veryDarkCyan rounded-2xl flex flex-col p-3 justify-between items-center w-[45%] max-375:w-full max-375:h-2/5">
            <div className="w-full flex max-665:h-full flex-col justify-around h-1/2">
              <div className="flex w-full max-665:flex-col  justify-between items-center">
                <div>
                  <h3 className="text-white text-[30px]">Tip Amount</h3>
                  <h4 className="text-darkGrayishCyan text-[30px]">/ person</h4>
                </div>
                <div>
                  <h2 className="text-[55px] text-strongCyan break-all">
                    ${tipAmount}
                  </h2>
                </div>
              </div>
              <div className="flex w-full max-665:flex-col justify-between items-center">
                <div>
                  <h3 className="text-white text-[30px]">Total</h3>
                  <h4 className="text-darkGrayishCyan text-[30px]">/ person</h4>
                </div>
                <div className="">
                  <h2 className="text-[55px] text-strongCyan max-665:text-[24px] break-all">
                    ${totalPerPerson}
                  </h2>
                </div>
              </div>
            ...
            <div className="border-transparent bg-strongCyan hover:bg-lightGrayishCyan border-2 w-full text-center rounded-sm">
              <button
                onClick={resetBtn}
                className="text-[35px] text-veryDarkCyan"
              >
                Reset
              </button>
            </div>
